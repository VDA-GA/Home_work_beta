...
def test_do_masks_number_card_or_account_for_card():
    assert do_masks_number_card_or_account('Visa Platinum 1234567890123456') == 'Visa Platinum 1234 56** **** 3456'


def test_do_masks_number_card_or_account_for_account():
    assert do_masks_number_card_or_account('Счет 12345678901234567890') == 'Счет **7890'
